iopctrl = function() {
    ...
    iopctrl.defaultSliderIndicator = function(g, w) {
        g.append("line")
            .attr("y1", -w/2)
            .attr("y2", w/4)
            .style("stroke", "#c81531")  //change needle color here
    ...
    iopctrl.arcslider = function()
    {
        ...
        var margin = {"top": 50, "left": 80, "bottom": 50, "right": 50};
...
//        g.append("circle").attr("r", 0.95 * r).attr("class", "knob");
    ...
    iopctrl.defaultGaugeIndicator = function(g, r) {
        g.append("path").attr("d", "M0 " + 0 * r + " L 0 " + -1.08 * r  + ""); //increased needle width
        g.append("circle").attr("r", 0.10 * r);
    };
    ...
    iopctrl.arcaxis = function() {
        ...
        function arcaxis(g) {
            g.each(function() {
                ...
                var lineEnter = tickEnter.select("line").style("stroke-width",1)  // icrease or decreased the tick width
